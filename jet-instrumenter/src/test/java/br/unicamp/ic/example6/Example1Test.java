package br.unicamp.ic.example6;
...
public class Example1Test {
    ...
    public void test1() throws Exception {
        ...
        final String className = "br.unicamp.ic.example6.Example1";
        ...
        final Class<?>[] parametersType = new Class<?>[] { Integer.class, Integer.class };
        ...
        method.invoke(o, new Object[] { 0, 0 });
        ...
        // -------------------- Execution ------------------------------
        instance.clearTrace();
        method.invoke(o, new Object[] { -1, 0 });
        ...
        // -------------------- Execution ------------------------------
        instance.clearTrace();
        method.invoke(o, new Object[] { 3, 0 });
        path = instance.getTrace();
        // -------------------- Check ----------------------------------
        Assert.assertNotNull("Path list must not be null.", path);
        Assert.assertEquals("Path must be 4 nodes long.", 4, path.size());
        Assert.assertEquals("Wrong path.", Arrays.asList(new Integer[] { 0, 1, 1, 2 }), path);
    }
