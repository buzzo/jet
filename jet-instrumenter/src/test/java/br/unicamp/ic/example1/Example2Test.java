...
public class Example2Test {
     ...
     * Static Method with one parameter.<br>
     * Called once.<br>
     * <br>
     * Simple CFG.<br>
    ...
    public void test1() throws Exception {
        ...
        final String className = "br.unicamp.ic.example1.Example2";
        ...
        final Method method = Example2Test.getMethod(methodName, clazz);
    ...
    public void test2() throws Exception {
        ...
        // -------------------- Execution ------------------------------
        instance.clearTrace();
        method.invoke(o, new Object[] { 200 });
        path = instance.getTrace();
        // -------------------- Check ----------------------------------
        Assert.assertNotNull("Path list must not be null.", path);
        Assert.assertEquals("Path must be 3 nodes long.", 3, path.size());
        Assert.assertEquals("Wrong path.", Arrays.asList(new Integer[] { 0, 1, 3 }), path);
    }
    ...
    public void test3() throws Exception {
        ...
        final Class<?> clazz = o.getClass();
        final Method method = Example2Test.getMethod(methodName, clazz);
        method.invoke(o, new Object[] { 101 });
        List<Integer> path = instance.getTrace();
        // -------------------- Check ----------------------------------
        Assert.assertNotNull("Path list must not be null.", path);
        Assert.assertEquals("Path must be 3 nodes long.", 3, path.size());
        ...
        // -------------------- Execution ------------------------------
        instance.clearTrace();
        method.invoke(o, new Object[] { 100 });
        path = instance.getTrace();
        // -------------------- Check ----------------------------------
        Assert.assertNotNull("Path list must not be null.", path);
        Assert.assertEquals("Path must be 3 nodes long.", 3, path.size());
        ...
        // -------------------- Execution ------------------------------
        instance.clearTrace();
        method.invoke(o, new Object[] { 1234 });
        path = instance.getTrace();
        // -------------------- Check ----------------------------------
        Assert.assertNotNull("Path list must not be null.", path);
        Assert.assertEquals("Path must be 3 nodes long.", 3, path.size());
